...
{
    [Table("EzyMonitorExpHeader")]
    public class EzyMonitorExpHeader
    {
        [Key]
        ...
        public Nullable<int> CompanyBranch { get; set; }
        ...
        public Nullable<int> BrokerBranch { get; set; }
        ...
        public Nullable<int> ReleasePort { get; set; }
        public Nullable<int> LoadPort { get; set; }
